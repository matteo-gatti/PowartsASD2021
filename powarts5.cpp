                        ...
                        while (padreAttuale1 != POWARTS || padreAttuale2 != POWARTS)
                        {
                            ...
                            if (padreAttuale2 != POWARTS) 
                            {
                                if (!padri.insert(padreAttuale2).second)
                                {
                                    ...
                                    cout<<"break p2:  "<<i<<endl;
                                    break;
                                }
                                padreAttuale2 = SPTree[padreAttuale2].padre;
                            }
                            if (padreAttuale1 == POWARTS && padreAttuale2 == POWARTS)
                            {
                                cout<<"dentro break:  "<<i<<" Powarts: " <<POWARTS<< " "<<padreAttuale1<<" "<<padreAttuale2 <<endl;
                                
                            }
                            cout<<"fuori break:  "<<i<<" \tp1: "<<padreAttuale1<<" \tp2 "<<padreAttuale2<<endl;
                            i++;
                        }                                                                       
